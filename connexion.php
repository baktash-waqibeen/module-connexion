<html lamg="fr">
	...
	<head>
		<meta charset="utf-8">
		<title>La Plateforme - Registration</title>
	</head>
		...
		<div id="mainWrapper">
			...
			<form method="post" action="">
				...
				<div style="justify-content:center;border-bottom:0px;">
					<input type="submit" value="Login" name="submitBtn" style="margin-right:20px;margin-left:-20px;"/>
					<input type="reset" value="Clear" name="resetBtn" required/>
				</div>
